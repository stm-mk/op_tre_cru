      ...
      <v-container>
        <v-row class="mt-2">
          ...
          <v-col cols="12" sm="6" md="6">
            <v-text-field v-model="post.friend_level" type="number" label="Friend Level" suffix="レベル"></v-text-field>
          </v-col>
          <v-col cols="12" sm="6" md="6">
            <v-autocomplete
          ...
          <v-col cols="12">
            <v-textarea v-model="post.description" label="あいさつ" auto-grow></v-textarea>
          </v-col>
        </v-row>
      </v-container>
